      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 leading-relaxed">
            Taklip 是一个专业的产品推荐和品牌信息平台，致力于为用户提供最准确、最及时的产品信息和品牌资讯。
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">taklipdotcom@gmail.com</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">北京市朝阳区建国门外大街1号</p>
            </div> */}
          </div>
        ...
        {/* Social Media */}
        <div>
          {/* <h3 className="text-lg font-semibold text-gray-900 mb-3">关注我们</h3>
